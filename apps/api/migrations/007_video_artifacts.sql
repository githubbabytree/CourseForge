...
ALTER TABLE artifacts ADD CONSTRAINT artifacts_media_type_check CHECK (
  ...
  (kind IN ('research-json','material-json','deck-spec','render-manifest','narration-manifest','tts-manifest','video-render-input','video-manifest') AND media_type = 'application/json')
);
